...
namespace AriesCloudAPI.Configuration
{
    ...
    public class AuthenticationOptions
    {
        ...
        /// <summary>
        /// Sets the cookie lifetime (only effective if the AriesCloudAPI-provided cookie handler is used)
        /// </summary>
        ...
        /// </summary>
        //public string CheckSessionCookieName { get; set; } = AriesCloudAPIConstants.DefaultCheckSessionCookieName;
