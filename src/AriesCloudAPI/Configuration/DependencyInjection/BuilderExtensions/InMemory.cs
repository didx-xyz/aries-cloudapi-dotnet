...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    /// </summary>
    public static class AriesCloudAPIBuilderExtensionsInMemory
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static IAriesCloudAPIBuilder AddInMemoryCaching(this IAriesCloudAPIBuilder builder)
        {
        ...
        /// <returns></returns>
        //public static IAriesCloudAPIBuilder AddInMemoryIdentityResources(this IAriesCloudAPIBuilder builder, IEnumerable<IdentityResource> identityResources)
        //{
        ...
        /// <returns></returns>
        //public static IAriesCloudAPIBuilder AddInMemoryIdentityResources(this IAriesCloudAPIBuilder builder, IConfigurationSection section)
        //{
        ...
        /// <returns></returns>
        //public static IAriesCloudAPIBuilder AddInMemoryApiResources(this IAriesCloudAPIBuilder builder, IEnumerable<ApiResource> apiResources)
        //{
        ...
        /// <param name="section">The configuration section containing the configuration data.</param>
        /// <returns></returns>
        //public static IAriesCloudAPIBuilder AddInMemoryApiResources(this IAriesCloudAPIBuilder builder, IConfigurationSection section)
        //{
        ...
        /// <returns></returns>
        //public static IAriesCloudAPIBuilder AddInMemoryApiScopes(this IAriesCloudAPIBuilder builder, IEnumerable<ApiScope> apiScopes)
        //{
        ...
        /// <param name="section">The configuration section containing the configuration data.</param>
        /// <returns></returns>
        //public static IAriesCloudAPIBuilder AddInMemoryApiScopes(this IAriesCloudAPIBuilder builder, IConfigurationSection section)
        //{
        ...
        /// <returns></returns>
        //public static IAriesCloudAPIBuilder AddInMemoryClients(this IAriesCloudAPIBuilder builder, IEnumerable<Client> clients)
        //{
        ...
        /// <param name="section">The configuration section containing the configuration data.</param>
        /// <returns></returns>
        //public static IAriesCloudAPIBuilder AddInMemoryClients(this IAriesCloudAPIBuilder builder, IConfigurationSection section)
        //{
        ...
        /// <param name="builder">The builder.</param>
        /// <returns></returns>
        public static IAriesCloudAPIBuilder AddInMemoryStateStore(this IAriesCloudAPIBuilder builder)
        {
            builder.Services.TryAddSingleton<IStateStore, InMemoryStateStore>();
