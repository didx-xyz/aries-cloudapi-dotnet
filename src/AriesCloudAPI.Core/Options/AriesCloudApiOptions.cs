namespace AriesCloudAPI.Core.Options
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Gets or sets the url to the Aries Hyperledger
        /// </summary>
        /// <value>
        ...
        /// <summary>
        /// Gets or sets the Goverance API Key for the Aries Hyperledger
        /// </summary>
        /// <value>
        /// Unique name of this server instance, e.g. https://myissuer.com
        /// </value>
        public string GoveranceAPIKey { get; set; }

        /// <summary>
        /// Gets or sets the Tenant Admin API Key for the Aries Hyperledger
        /// </summary>
        /// <value>
        /// Unique name of this server instance, e.g. https://myissuer.com
        /// </value>
        public string TenantAdminAPIKey { get; set; }
